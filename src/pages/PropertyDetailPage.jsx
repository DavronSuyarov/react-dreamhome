                ...
                <div className='wrap-floor wrap-property wrap-style'>
                  ...
                  <div className='flat-accordion fl-faq-content'>
                    <div className='flat-toggle '>
                      <div className='toggle-title active flex justify-space'>
                      ...
                      <div className='toggle-content section-desc'>
                        ...
                        <p className='texts text-color-2'>
                          ...
                          tincidunt augue. Sed consectetur magna elit, sit amet
                          faucibus tortor sodales vitae. Maecenas quis arcu est.
                          Nam sit amet neque vestibulum, fringilla elit sit
                          amet, volutpat nunc.
                        </p>
                    ...
                    <div className='flat-toggle '>
                      <div className='toggle-title flex justify-space'>
                        <div className='btn-toggle' />
                    ...
                    <div className='respond-comment'>
                      ...
                      >
                        ...
                        <div className='wg-box'>
                          ...
                          <div className='nice-select' tabIndex={0}>
                            ...
                            <ul className='list style'>
                              ...
                              <li data-value={36} className='option selected'>
                                36 months
                              </li>
                        ...
                        <div className='inner-1 form-wg flex'>
                          ...
                          <div className='wg-box'>
                            ...
                            <div className='nice-select ' tabIndex={0}>
                              ...
                              <ul className='list'>
                                <li data-value='weekly' className='option'>
                                  Weekly
                                </li>
                                <li
                                  data-value='monthly'
                                ...
                                <li data-value='annual' className='option'>
                                  Annual
                                </li>
                              </ul>
                            </div>
                        ...
                        <div className='inner-2 justify-space align-center flex'>
                          <div className='title-user fw-6'>Monthly payment</div>
                    ...
                    <div className='flat-tabs style2'>
                      <div className='box-tab center'>
                        <ul className='menu-tab tab-title flex'>
                          ...
                          <li className='item-title style btn-1'>
                    ...
                    <div className='author-box flex align-center'>
                      ...
                      <div className='content'>
                        ...
                        <a
                          ...
                          href='../../cdn-cgi/l/email-protection.html#096a68646c7b66677e6065656068647a6667496e64686065276a6664'
                        >
                          <span
                            className='__cf_email__'
                            data-cfemail='a0c3c1cdc5d2cfced7c9ccccc9c1cdd3cfcee0c7cdc1c9cc8ec3cfcd'
                          >
                            [email&nbsp;protected]
                          </span>
                        </a>
                    ...
                    <div className='box box-dream hv-one'>
                      ...
                      <div className='content'>
                        ...
                        <div className='money fs-18 fw-6 text-color-3'>
                          <a href='property-detail-v2.html'>$7,500</a>
                        </div>
                        <div className='icon-box flex'>
                          <div className='icons icon-1 flex text-color-4'>
                            <span>Beds: </span>
                            <span className='fw-6'>4</span>
                          </div>
                          <div className='icons icon-2 flex'>
