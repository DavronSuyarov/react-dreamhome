                ...
                <div className='flat-blog'>
                  <div className='box-heading '>
                    <div className='image relative '>
                      <img
                        src='assets/images/img-box/blog-grid.jpg'
                        alt='images'
                      />
                    ...
                    <div className='contents center'>
                      <div className='title-heading fs-30 fw-7 lh-45'>
                        Real estate shifts: Prices and sales trending down in
                        two different spheres
                      </div>
                      <h4 className='fw-4'>
                        Hosted by Brian Sullivan, “Last Call” is a fast-paced,
                        entertaining business show that explores the
                        intersection of money, culture and policy. Tune in
                        Monday through Friday at 7 p.m. ET on...
                      </h4>
                    </div>
                  </div>
                  <div className='wrap-blog form-wg flex flex-wrap'>
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-1.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-2.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-3.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-4.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-5.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-6.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-7.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-8.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-9.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
                    ...
                    <div className='box hover-img wg-box'>
                      <div className='images img-style relative '>
                        <img
                          src='assets/images/img-box/blog-grid-10.jpg'
                          alt='images'
                        />
                        <div className='sub-box flex align-center fs-13 fw-6'>
                          <div className='title-1'>April</div>
