              ...
              <div className='post'>
                <div className='box flex '>
                  ...
                  <div className='content '>
                    <div className='titles fs-22 fw-7 lh-33'>
                      Cameron Williamson
                    </div>
                    <div className='sub-text flex'>
                      <p className>Company Agent at </p>
                    ...
                    <div className='icon-group'>
                      ...
                      <div className='icon-email'>
                        <a
                          href='../../cdn-cgi/l/email-protection.html#4c282d3e202922293e232e293e383f23220c2b212d2520622f2321'
                          className='font-2 '
                        >
                          <span
                            className='__cf_email__'
                            data-cfemail='dfbcbeb2baadb0b1a8b6b3b3b6beb2acb0b19fb8b2beb6b3f1bcb0b2'
                          >
                            [email&nbsp;protected]
                          </span>
                        </a>
                        ...
                        <div className='box box-dream flex hv-one '>
                            ...
                            <div className='swiper-container noo carousel-2 img-style'>
                              ...
                              <div className='swiper-wrapper '>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-3.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-2.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-5.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-1.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-4.jpg'
                                    alt='images'
                                  />
                                </div>
                              </div>
                          ...
                          <div className='content'>
                            ...
                            <div className='text-address'>
                              <p className='p-12'>
                                58 Hullbrook Road, Billesley, B13...
                              </p>
                            </div>
                            ...
                            <div className='img-box flex justify-space align-center'>
                              <div className='img-author flex align-center'>
                                <img
                                  src='assets/images/author/author-list-1.jpg'
                                  alt='images'
                                />
                          ...
                          <div className='image-group relative '>
                            ...
                            <div className='swiper-container noo carousel-2 img-style'>
                              ...
                              <div className='swiper-wrapper '>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-6.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-7.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-13.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-15.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-12.jpg'
                                    alt='images'
                                  />
                                </div>
                              </div>
                          ...
                          <div className='image-group relative '>
                            ...
                            <div className='swiper-container noo carousel-2 img-style'>
                              ...
                              <div className='swiper-wrapper '>
                                ...
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-11.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                          ...
                          <div className='image-group relative  '>
                            ...
                            <div className='swiper-container noo carousel-2 img-style'>
                              ...
                              <div className='swiper-wrapper '>
                                <div className='swiper-slide'>
                                  <img
                                    src='assets/images/house/properties-rent-9.jpg'
                                    alt='images'
                                  />
                                </div>
                                <div className='swiper-slide'>
                    ...
                    <div className='author-box flex align-center'>
                      ...
                      <div className='content'>
                        ...
                        <h5 className='link-style-1'>
                          <a href='tel:0123456789'>(405) 555-000-999</a>
                        </h5>
                        <a
                          className='fs-12 lh-18'
                          href='../../cdn-cgi/l/email-protection.html#e380828e86918c8d948a8f8f8a828e908c8da3848e828a8fcd808c8e'
                        >
                          <span
                            className='__cf_email__'
                            data-cfemail='85e6e4e8e0f7eaebf2ece9e9ece4e8f6eaebc5e2e8e4ece9abe6eae8'
                          >
                            [email&nbsp;protected]
                          </span>
                        </a>
                            ...
                            <div className='form-group-2 form-style2'>
                              <div className='group-select'>
                                <div className='nice-select' tabIndex={0}>
                                  ...
                                  <ul className='list'>
                                    <li data-value='Condo' className='option'>
                                      Condo
                                    </li>
                                    <li
                              ...
                              <div className='group-select'>
                                <div className='nice-select' tabIndex={0}>
                                  ...
                                  <ul className='list'>
                                    ...
                                    <li data-value='America' className='option'>
                                      America
                                    </li>
                                    <li
                                      data-value='England'
