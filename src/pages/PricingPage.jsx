            ...
            <div className='col-lg-12'>
              <div className='heading-section center'>
                ...
                <div className='text-box flex justify-center flex-wrap'>
                  ...
                  <a className='fw-7 font-2 text-color-4 text-line'>
                    {' '}
                    full documentation
                  </a>
                </div>
              ...
              <div className='flat-toggle '>
                ...
                <div className='toggle-content section-desc'>
                  <p className='texts text-color-2'>
                    Proin sed tellus porttitor, varius mauris vitae, tincidunt
                    augue. Sed consectetur magna elit, sit amet faucibus tortor
                    sodales vitae. Maecenas quis arcu est. Nam sit amet neque
            ...
            <div className='col-lg-6'>
              <div className='flat-toggle '>
                <div className='toggle-title flex align-center'>
                  <i className='fal fa-question-circle' />
                  <div className='fw-6'>
                    Cras ac purus sed lectus volutpat feugiat in et nunc.
                  </div>
                  <div className='btn-toggle' />
                </div>
                <div className='toggle-content section-desc'>
            ...
            <div className='col-lg-6'>
              <div className='flat-toggle '>
                <div className='toggle-title flex align-center'>
                  <i className='fal fa-question-circle' />
                  <div className='fw-6'>
                    Fusce at arcu dapibus, fermentum diam sed, pretium mi.
                  </div>
                  <div className='btn-toggle' />
                </div>
                <div className='toggle-content section-desc'>
            ...
            <div className='col-lg-6'>
              <div className='flat-toggle '>
                <div className='toggle-title flex align-center'>
                  <i className='fal fa-question-circle' />
                  <div className='fw-6'>
                    Nulla facilisis lorem vel turpis hendrerit faucibus.
                  </div>
                  <div className='btn-toggle' />
                </div>
                <div className='toggle-content section-desc'>
            ...
            <div className='col-lg-6'>
              <div className='flat-toggle '>
                <div className='toggle-title flex align-center'>
                  <i className='fal fa-question-circle' />
                  <div className='fw-6'>
                    Pellentesque faucibus ante id nunc molestie elementum.
                  </div>
                  <div className='btn-toggle' />
                </div>
                <div className='toggle-content section-desc'>
