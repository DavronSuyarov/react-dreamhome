            ...
            <div className='col-lg-7 col-md-7'>
              <div className='heading-about'>
                ...
                <h4>
                  ...
                  Egestas vitae auctor in gravida tellus vestibulum faucibus in
                  ut. Dolor bibendum suspendisse vestibulum ullamcorper morbi
                  morbi vulputate.
                </h4>
                <p className='text-1 text-color-2'>
                  ...
                  magna. Mauris turpis lorem, ultricies vel justo sed, ultrices
                  auctor nisi.{' '}
                </p>
                <div className='text-box'>
                  <p className='font-2 fw-5 font-italic text-color-2'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Suspendisse auctor, mi euismod dignissim scelerisque, eros
                    augue vehicula lectus, quis vestibulum enim augue ut est
                  </p>
                </div>
              ...
              <div className='icon-box icon-box2 center'>
                ...
                <div className='title-icon fw-8 fs-40 font-2 relative'>87%</div>
                <h5>sales rate</h5>
              </div>
          ...
          <div className='row'>
            ...
            <div className='col-lg-4 col-md-4'>
              <div className='box'>
                ...
                <p className='text-color-2'>
                  condimentum id. Nulla congue nunc vitae odio dictum, euismod
                  mattis eros dapibus
                </p>
              </div>
            </div>
            ...
            <div className='col-lg-4 col-md-4'>
              <div className='box'>
                ...
                <p className='text-color-2'>
                  Nulla facilisi. Praesent vulputate mollis ante feugiat mattis.
                  Vestibulum felis nunc, faucibus ac varius eget, tempor
                </p>
              </div>
            </div>
          </div>
              ...
              <div className='wrap-why-choose flex'>
                <div className='box center hv-one'>
                  ...
                  <h4 className='link-style-1'>
                    <a href='#'>Thousands of posts every day</a>
                  </h4>
                  ...
                  <p className='text-color-2'>
                    The lists are always refreshed and updated constantly, you
                    will never miss
                  </p>
            ...
            <div className='col-lg-4 col-md-4'>
              <div className='box-icon flex align-center'>
                ...
                <div className='content'>
                  ...
                  <a href='../../cdn-cgi/l/email-protection.html#5d35383131322e282d2d322f291d3a303c3431733e3230'>
                    <div className='fs-16'>
                      <span
                        className='__cf_email__'
                        data-cfemail='99f1fcf5f5f6eaece9e9f6ebedd9fef4f8f0f5b7faf6f4'
                      >
                        [email&nbsp;protected]
                      </span>
                    </div>
          ...
          <div className='row'>
              ...
              <div className='box hover-img'>
                <div className='images relative img-style'>
                  <a href='agents-detail.html'>
                    <img src='assets/images/img-box/meet-4.jpg' alt='images' />
                  </a>
                ...
                <div className='content flex justify-space'>
                  <div className='inner'>
                    <h3 className='link-style-1'>
                      <a href='agents-detail.html'>Wade Warren</a>
                    </h3>
            ...
            <div className='col-lg-4 col-md-4'>
              <div className='box hover-img'>
                <div className='images relative img-style'>
                  <a href='agents-detail.html'>
                    <img src='assets/images/img-box/meet-5.jpg' alt='images' />
                  </a>
                  <div className='icon-socials'>
                    <a href='#'>
                      <i className='fab fa-facebook-f' />
            ...
            <div className='col-lg-4 col-md-4'>
              <div className='box hover-img'>
                <div className='images relative img-style'>
                  <a href='agents-detail.html'>
                    <img src='assets/images/img-box/meet-6.jpg' alt='images' />
                  </a>
                  <div className='icon-socials'>
                    <a href='#'>
                      <i className='fab fa-facebook-f' />
            ...
            <div className='col-lg-12'>
              <div className='box-text flex justify-center'>
                ...
                <a href='contact.html' className='text-color-3 font-2 fw-7'>
                  {' '}
                  Contact us
                </a>
              </div>
