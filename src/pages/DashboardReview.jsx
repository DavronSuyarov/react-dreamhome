                ...
                <div className='content fs-13 lh-16'>
                  ...
                  <h5>
                    <a
                      ...
                      data-cfemail='17637f727a7264717b766357707a767e7b3974787a'
                    >
                      [email&nbsp;protected]
                    </a>
                  </h5>
          ...
          <div className='container7'>
            <div className='row'>
              <div className='col-lg-12'>
                <div className='title-group fs-30 lh-45 fw-7'>All review</div>
              </div>
            </div>
          </div>
        </section>
                    ...
                    <ul>
                      ...
                      <li>
                        <div className='image-box flex align-center'>
                          <div className='images'>
                            <img
                              src='assets/images/author/author-list-4.jpg'
                              alt='images'
                            />
                          </div>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            ...
                            ultricies vel justo sed, ultrices auctor nisi.{' '}
                          </p>
                          <div className='star flex'>
                            <svg
                              version='1.1'
                      ...
                      <li>
                        <div className='image-box flex align-center'>
                          <div className='images'>
                            <img
                              src='assets/images/author/author-list-8.jpg'
                              alt='images'
                            />
                          </div>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            Sed ac ultrices nunc, in posuere lacus. Pellentesque
                            ullamcorper pretium purus sit amet molestie.
                          </p>
                          <div className='star flex'>
                            <svg
                              version='1.1'
                      ...
                      <li>
                        <div className='image-box flex align-center'>
                          <div className='images'>
                            <img
                              src='assets/images/author/author-list-7.jpg'
                              alt='images'
                            />
                          </div>
                      ...
                      <li>
                        <div className='image-box flex align-center'>
                          <div className='images'>
                            <img
                              src='assets/images/author/author-list-5.jpg'
                              alt='images'
                            />
                          </div>
