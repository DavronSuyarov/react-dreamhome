              ...
              <div className='post'>
                <div className='category-filter flex justify-space'>
                  ...
                  <div className='box-2 flex'>
                    <a href='#' className='btn-view grid active'>
                      <svg
                        width={25}
                        height={25}
                        viewBox='0 0 25 25'
                    ...
                    <a href='#' className='btn-view list'>
                      <svg
                        width={25}
                        height={25}
                        viewBox='0 0 25 25'
                ...
                <div className='wrap-list flex flex-wrap form-wg'>
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-1.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-1.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#05696a7760686d6a707660456268646c692b666a68'>
                            <span
                              className='__cf_email__'
                              data-cfemail='86eae9f4e3ebeee9f3f5e3c6e1ebe7efeaa8e5e9eb'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-2.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-2.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#04686b7661696c6b717761446369656d682a676b69'>
                            <span
                              className='__cf_email__'
                              data-cfemail='85e9eaf7e0e8edeaf0f6e0c5e2e8e4ece9abe6eae8'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-3.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-3.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#e38f8c91868e8b8c969086a3848e828a8fcd808c8e'>
                            <span
                              className='__cf_email__'
                              data-cfemail='90fcffe2f5fdf8ffe5e3f5d0f7fdf1f9fcbef3fffd'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-4.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-4.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#c5a9aab7a0a8adaab0b6a085a2a8a4aca9eba6aaa8'>
                            <span
                              className='__cf_email__'
                              data-cfemail='8de1e2ffe8e0e5e2f8fee8cdeae0ece4e1a3eee2e0'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-5.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-5.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#771b1805121a1f1802041237101a161e1b5914181a'>
                            <span
                              className='__cf_email__'
                              data-cfemail='5f33302d3a3237302a2c3a1f38323e3633713c3032'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-6.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-6.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#85e9eaf7e0e8edeaf0f6e0c5e2e8e4ece9abe6eae8'>
                            <span
                              className='__cf_email__'
                              data-cfemail='f39f9c81969e9b9c868096b3949e929a9fdd909c9e'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-7.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-7.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#e5898a9780888d8a909680a58288848c89cb868a88'>
                            <span
                              className='__cf_email__'
                              data-cfemail='f995968b9c9491968c8a9cb99e94989095d79a9694'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
                  ...
                  <div className='box box-agencies hover-img2 wg-box'>
                    <div className='images relative img-style2'>
                      <img
                        className='img2'
                        src='assets/images/img-box/agencies-8.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='icon-brand'>
                      <img
                        src='assets/images/img-box/agencies-brand-8.jpg'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <ul className='inner flex'>
                        ...
                        <li className='one fw-6'>Email:</li>
                        <li className='two'>
                          <a href='../../cdn-cgi/l/email-protection.html#f69a9984939b9e99838593b6919b979f9ad895999b'>
                            <span
                              className='__cf_email__'
                              data-cfemail='98f4f7eafdf5f0f7edebfdd8fff5f9f1f4b6fbf7f5'
                            >
                              [email&nbsp;protected]
                            </span>
                          </a>
