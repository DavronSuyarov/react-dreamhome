...
const DashboardProperties = () => {
  return (
    <>
                ...
                <div className='content fs-13 lh-16'>
                  ...
                  <h5>
                    <a
                      ...
                      data-cfemail='4c38242921293f2a202d380c2b212d2520622f2321'
                    >
                      [email&nbsp;protected]
                    </a>
                  </h5>
      ...
      {/* End Mobile Menu */}
      <div className='btn2 header-item ' id='left-menu-btn'>
                      ...
                      <div className='wg-box2 select-group'>
                        ...
                        <div className='nice-select' tabIndex={0}>
                          ...
                          <ul className='list'>
                            ...
                            <li data-value='like' className='option'>
                              Like
                            </li>
                            <li data-value='love' className='option'>
                              Love{' '}
                            </li>
                            <li data-value='care' className='option'>
                              Care
                            </li>
                            <li data-value='feel' className='option'>
                              Feel
                            </li>
                            <li data-value='hate' className='option'>
                              Hate
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className='info-box info-wg'>
                    <div className='inner-1 form-wg flex'>
                      <div className='wg-box'>
                        ...
                        <div className='nice-select' tabIndex={0}>
                          <span className='current font-2 fw-7'>$ 750.00</span>
                          <span className='month'>Per-Month</span>
                          <ul className='list style'>
                            <li data-value={500} className='option'>
                              $ 500.00
                            </li>
                            <li data-value={750} className='option selected'>
                              $ 750.00
                            </li>
                      ...
                      <div className='wg-box'>
                        ...
                        <div className='nice-select ' tabIndex={0}>
                          ...
                          <ul className='list style'>
                            ...
                            <li data-value={56} className='option selected'>
                              $ 56.00
                            </li>
                            <li data-value={100} className='option'>
                              $ 100.00
                            </li>
                            <li data-value={200} className='option'>
                              $ 200.00
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className='wg-box2 select-group'>
                        ...
                        <div className='nice-select' tabIndex={0}>
                          ...
                          <ul className='list'>
                            ...
                            <li data-value={2000} className='option selected'>
                              2000.00$
                            </li>
                            <li data-value={3000} className='option'>
                              3000.00$
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className='wg-box2 select-group'>
                        ...
                        <div className='nice-select' tabIndex={0}>
                          ...
                          <ul className='list style'>
                            ...
                            <li data-value='Open' className='option'>
                              Open
                            </li>
                            <li data-value='Close' className='option selected'>
                              Close
                            </li>
                            <li data-value='Repair' className='option'>
                              Repair
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className='wg-box2 select-group'>
                        ...
                        <div className='nice-select' tabIndex={0}>
                          ...
                          <ul className='list'>
                            ...
                            <li data-value='floor-standing' className='option'>
                              Floor-standing bath
                            </li>
                      ...
                      <div className='wg-box2 select-group'>
                        ...
                        <div className='nice-select' tabIndex={0}>
                          ...
                          <ul className='list'>
                            ...
                            <li data-value={2024} className='option'>
                              2024
                            </li>
                            <li data-value={2022} className='option'>
                              2022
                            </li>
                            <li data-value={2023} className='option'>
                              2023
                            </li>
                          </ul>
                        </div>
