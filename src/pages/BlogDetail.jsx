              ...
              <div className='post'>
                ...
                <div className='icon-boxs flex'>
                  <div className='icon flex align-center'>
                    ...
                    <span className='fw-6 text-color-3 fs-13'>
                      Kathryn Murphy
                    </span>
                  </div>
                  <div className='icon flex align-center'>
                ...
                <div className='texts-1 fs-16 fw-8 font-2 lh-29'>
                  Mortgage rates fell last week, but demand for home loans
                  didn’t move higher as a result. Other aspects of today’s
                  housing market are outweighing the benefit of lower mortgage
                  rates right now, namely a lack of supply.
                </div>
                <div className='image'>
                  <img
                    src='assets/images/img-box/blog-detail.jpg'
                    alt='images'
                  />
                </div>
                <div className='content-img'>
                  <div className='sub-title fs-12 fw-6'>
                    A “For Sale” sign outside a house in Albany, California, on
                    Tuesday, May 31, 2022.
                  </div>
                ...
                <p className='texts-2 fs-16 font-2 lh-29 text-color-2'>
                  The average contract interest rate for 30-year fixed-rate
                  mortgages with conforming loan balances ($726,200 or less)
                  decreased to 6.40% from 6.45%, with points falling to 0.59
                  from 0.62 (including the origination fee) for loans with a 20%
                  down payment. It had been over 7% just a month ago.
                </p>
                <p className='texts-2 fs-16 font-2 lh-29 text-color-2'>
                  Mortgage applications to purchase a home, however, dropped 4%
                  last week compared with the previous week, according to the
                  Mortgage Bankers Association’s seasonally adjusted index.
                  Demand was 35% lower than the same week one year ago.
                </p>
                <div className='text-box'>
                  <p className='texts fs-16 font-2 lh-29 text-color-2'>
                    “Spring has arrived, but the housing market is missing the
                    customary burst in listings and purchase activity that
                    typically mark the season. After four weeks of increasing
                    purchase application activity, volume declined a bit this
                    week even with another small drop in mortgage rates,” said
                    Mike Fratantoni, MBA’s chief economist.
                  </p>
                </div>
                <p className='texts-2 fs-16 font-2 lh-29 text-color-2'>
                  New listings were down 20% year over year in March, according
                  to Realtor.com, and total inventory was about half of what it
                  was in March 2019, pre-Covid pandemic.
                </p>
                <div className='text-box'>
                  <p className='texts fs-16 font-2 lh-29 text-color-2 fw-6'>
                    “Although the mortgage rate for conforming balance loans
                    declined by five basis points over the week to 6.40%, the
                    mortgage rate for jumbo loans increased by nine basis points
                    to 6.36%,” added Fratantoni. “While we have seen relative
                    weakness at the high end of the housing market in recent
                    months, the divergence in rates suggests that banks may be
                    tightening credit in response to recent challenges,
                    preserving balance sheet capacity as deposit balances have
                    declined.”
                  </p>
                </div>
                <p className='texts-2 fs-16 font-2 lh-29 text-color-2'>
                ...
                <p className='texts-2 fs-16 font-2 lh-29 text-color-2'>
                  Demand for Federal Housing Administration and Department of
                  Veterans Affairs loans, which are favored by lower-income
                  borrowers due to low down payment requirements, declined more
                  than those for conventional loans. While there is strong
                  demand from first-time homebuyers, with millennials hitting
                  their peak buying age, affordability is still a challenge
                  right now.
                </p>
                <p className='texts-3 fs-16 font-2 lh-29 text-color-2'>
                  Applications to refinance a home loan also dropped, down 5%
                  for the week and 59% lower than the same week a year ago. The
                  refinance share of mortgage activity decreased to 28.6% of
                  total applications from 29.1% the previous week. Rates are 150
                  basis points higher than they were at the same time last year,
                  so there are precious few borrowers who can now benefit from a
                  refinance.
                </p>
              ...
              <div className='box hover-img'>
                <div className='images img-style relative '>
                  ...
                  <div className='sub-box flex align-center fs-13 fw-6'>
                    <div className='title-1'>April</div>
                    <a className='title-2 text-color-3'>Housing</a>
                  </div>
                </div>
                <div className='content center'>
                  ...
                  <div className='meta'>
                    <a
                      ...
                      className='btn-button flex align-center justify-center fs-13 fw-6 text-color-3'
                    >
                      <span>Read more </span>
                      <svg
                        width={13}
