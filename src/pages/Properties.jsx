...
const Properties = () => {
  return (
    <div>
      <section className='flat-title-page inner style'>
        {' '}
              ...
              <div className='page-title-heading'>
                <div className='heading-inner'>
                  <div className='heading'>
                    <span>Gorgeous Apartment Building</span>{' '}
                  </div>
                  <div className='wg-dream'>
                    <div className='icon-boxs flex'>
                      ...
                      <div className='icons icon-4 flex'>
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    <div className='image-group relative '>
                      ...
                      <div className='swiper-container noo carousel-2 img-style'>
                        <a href='property-detail-v1.html' className='icon-plus'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        <a className='compare flex align-center fw-6' href='#'>
                          Compare
                        </a>
                        <div
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        ...
                        >
                          <img
                            src='assets/images/author/author-20.jpg'
                            alt='images'
                          />
                        </div>
                        <div className='days'>3 years ago</div>
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    <div className='image-group relative '>
                      ...
                      <div className='swiper-container noo carousel-2 img-style'>
                        ...
                        <div className='swiper-wrapper '>
                          <div className='swiper-slide'>
                            <img
                              src='assets/images/house/featured-39.jpg'
                              alt='images'
                            />
                          </div>
                          <div className='swiper-slide'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        ...
                        >
                          <img
                            src='assets/images/author/author-21.jpg'
                            alt='images'
                          />
                        </div>
                        <div className='days'>3 years ago</div>
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        ...
                        >
                          <img
                            src='assets/images/author/author-22.jpg'
                            alt='images'
                          />
                        </div>
                        <div className='days'>3 years ago</div>
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    <div className='image-group relative '>
                      ...
                      <div className='swiper-container noo carousel-2 img-style'>
                        ...
                        <div className='swiper-wrapper '>
                          <div className='swiper-slide'>
                            <img
                              src='assets/images/house/featured-41.jpg'
                              alt='images'
                            />
                          </div>
                          <div className='swiper-slide'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        ...
                        >
                          <img
                            src='assets/images/author/author-23.jpg'
                            alt='images'
                          />
                        </div>
                        <div className='days'>3 years ago</div>
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        ...
                        >
                          <img
                            src='assets/images/author/author-24.jpg'
                            alt='images'
                          />
                        </div>
                        <div className='days'>3 years ago</div>
                  ...
                  <div className='box box-dream hv-one style-dream wg-box'>
                    ...
                    <div className='content'>
                      ...
                      <div className='days-box flex justify-space align-center'>
                        ...
                        >
                          <img
                            src='assets/images/author/author-25.jpg'
                            alt='images'
                          />
                        </div>
                        <div className='days'>3 years ago</div>
                  ...
                  <div className='widget widget-contact'>
                    ...
                    <div className='box-contact flex align-center'>
                      <div className='img-author'>
                        <img
                          src='assets/images/author/author-sidebar-1.jpg'
                          alt='images'
                        />
                      </div>
                      <div className='content'>
                        <p>Robert Fox</p>
                        <a className='fw-6' href='tel:012345678'>
                          (201) 555-0124
                        </a>
                      </div>
                    </div>
                    ...
                    <div className='box-contact flex align-center'>
                      <div className='img-author'>
                        <img
                          src='assets/images/author/author-sidebar-3.jpg'
                          alt='images'
                        />
                      </div>
                      <div className='content'>
