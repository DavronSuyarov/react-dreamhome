                ...
                <div className='wrap-list form-wg flex flex-wrap'>
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-3.jpg'
                          alt='images'
                        />
                      </a>
                    ...
                    <div className='content flex justify-space'>
                      <div className='inner'>
                        <h3 className='link-style-1'>
                          <a href='agents-detail.html'>Leslie Alexander</a>
                        </h3>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-1.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                    ...
                    <div className='content flex justify-space'>
                      <div className='inner'>
                        <h3 className='link-style-1'>
                          <a href='agents-detail.html'>Darlene Robertson</a>
                        </h3>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-2.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-7.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-8.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-9.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-10.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-11.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
                  ...
                  <div className='box wg-box hover-img'>
                    <div className='images relative img-style'>
                      <a href='agents-detail.html'>
                        <img
                          src='assets/images/img-box/meet-12.jpg'
                          alt='images'
                        />
                      </a>
                      <div className='icon-socials'>
