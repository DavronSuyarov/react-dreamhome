                ...
                <div className='content fs-13 lh-16'>
                  ...
                  <h5>
                    <a
                      ...
                      data-cfemail='32465a575f5741545e534672555f535b5e1c515d5f'
                    >
                      [email&nbsp;protected]
                    </a>
                  </h5>
                ...
                <div className='wrap-count flex-wrap flex'>
                  <div className='box tf-counter flex  bg-white'>
                    ...
                    <div className='counter-box one '>
                      <div className='title-count fw-6 fs-16 text-color-4'>
                        Your listing
                      </div>
                      <div className='count-number flex'>
                        <div
                          ...
                          data-inviewport='yes'
                        />
                        <div className='sub-title fw-6 text-color-4'>
                          /50 remaining
                        </div>
                      </div>
                    </div>
                ...
                <div className='tf-new-listing '>
                  <div className='new-listing bg-white'>
                        ...
                        <div className='group-select'>
                          <div className='nice-select' tabIndex={0}>
                            ...
                            <ul className='list style'>
                              ...
                              <li data-value='recently' className='option'>
                                Recently
                              </li>
                              <li data-value='yesterday' className='option '>
                                Yesterday
                              </li>
                              <li data-value='week' className='option'>
                                Week
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className='sub-text fs-12 lh-18 '>
                      <span className='one font-2 fw-7'>26</span>{' '}
                              ...
                              <td>
                                <div className='candidates-wrap flex'>
                                  <div className='images'>
                                    <img
                                      src='assets/images/house/dashboard-house-1.jpg'
                                      alt='images'
                                    />
                                  </div>
                            ...
                            <tr className='file-delete'>
                              <td>
                                <div className='candidates-wrap flex'>
                                  <div className='images'>
                                    <img
                                      src='assets/images/house/dashboard-house-3.jpg'
                                      alt='images'
                                    />
                                  </div>
                                  <div className='content'>
                            ...
                            <tr className='file-delete'>
                              <td>
                                <div className='candidates-wrap flex'>
                                  <div className='images'>
                                    <img
                                      src='assets/images/house/dashboard-house-4.jpg'
                                      alt='images'
                                    />
                                  </div>
                                  <div className='content'>
                              ...
                              <td>
                                <div className='status-wrap'>
                                  <div className='button-status fs-12 fw-6 lh-18 style-2'>
                                    {' '}
                                    Sold
                                  </div>
                                </div>
                            ...
                            <tr className='file-delete'>
                              <td>
                                <div className='candidates-wrap flex'>
                                  <div className='images'>
                                    <img
                                      src='assets/images/house/dashboard-house-5.jpg'
                                      alt='images'
                                    />
                                  </div>
                                  <div className='content'>
                    ...
                    <ul>
                      <li>
                        <div className='image-box flex align-center'>
                          <div className='images'>
                            <img
                              src='assets/images/author/author-list-3.jpg'
                              alt='images'
                            />
                          </div>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            ...
                            elit. Aenean scelerisque vulputate tincidunt.
                            Maecenas lorem sapien
                          </p>
                        </div>
                      </li>
                      <li>
                        <div className='image-box flex align-center'>
                          <div className='images'>
                            <img
                              src='assets/images/author/author-dashboard-top.jpg'
                              alt='images'
                            />
                          </div>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            Nullam lacinia lorem id sapien suscipit, vitae
                            pellentesque metus maximus. Duis eu mollis dolor.
                            Proin faucibus eu lectus a eleifend
                          </p>
                        </div>
                      </li>
                      <li>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            In consequat lacus augue, a vestibulum est aliquam
                            non
                          </p>
                        </div>
                      </li>
                      <li>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            Cras congue in justo vel dapibus. Praesent euismod,
                            lectus et aliquam pretium
                          </p>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className='reviews-sidebar messages-sidebar bg-white'>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <div className='content'>
                          <p className='text-color-2'>
                            Donec bibendum nibh quis nisl luctus, at aliquet
                            ipsum bibendum. Fusce at dui tincidunt nulla semper
                            venenatis at et magna. Mauris turpis lorem,
                            ultricies vel justo sed.
                          </p>
                          <div className='star flex'>
                            <svg
                              version='1.1'
