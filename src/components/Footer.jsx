  ...
  return (
    <>
      <div>
            ...
            <div className='row'>
                ...
                <div className='group-icon'>
                  <div className='box-icons flex'>
                    <div className='images'>
                      <img
                        src='assets/images/icon/footer-icon-1.png'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      <div className='title-icon fs-30 lh-45 fw-7 text-color-2'>
                        You need a house
                      </div>
                      <p className='font-2 text-color-2'>
              ...
              <div className='col-lg-6 col-md-12 col-12'>
                <div className='group-icon group-2'>
                  <div className='box-icons flex'>
                    <div className='images'>
                      <img
                        src='assets/images/icon/footer-icon-2.png'
                        alt='images'
                      />
                    </div>
                    <div className='content'>
                      ...
                      <p className='font-2 text-color-2'>
                        We will connect you to thousands of people who need to
                        buy a home.
                      </p>
                    </div>
                  </div>
              ...
              <div className='col-lg-3 col-md-6 col-12'>
                <div className='widget widget-info'>
                  ...
                  <p className='text-1 text-color-8'>
                    3891 Ranchview Dr. Richardson, California 62639
                  </p>
                  <p className='text-2 text-color-8'>
              ...
              <div className='col-lg-3 col-md-6 col-12'>
                <div className='widget widget-menu style-2'>
                  ...
                  <div className='box-icon flex align-center'>
                    <div className='icon flex-none'>
                      ...
                      >
                        <g opacity='0.3'>
                          ...
                          >
                            <path
                              d='M43.5001 43.5V6.49987H6.5V43.5H43.5001Z'
                              fill='white'
                              stroke='white'
                            />
                          </mask>
                          <g mask='url(#mask0_2290_9114)'>
                            ...
                            />
                            <path
                              d='M30.366 11.5664L24.9999 7.11327L19.6339 11.5664'
                              stroke='white'
                              strokeMiterlimit={10}
                              strokeLinecap='round'
                              strokeLinejoin='round'
                    ...
                    <div className='content'>
                      <p>Email:</p>
                      <a href='../../cdn-cgi/l/email-protection.html#683a0d09040d1b1c091c0d0b18280f05090104460b0705'>
                        <h5 className='fw-4 text-color-8'>
                          <span
                            className='__cf_email__'
                            data-cfemail='bdefd8dcd1d8cec9dcc9d8decdfddad0dcd4d193ded2d0'
                          >
                            [email&nbsp;protected]
                          </span>
                        </h5>
              ...
              <div className='col-lg-3 col-md-6 col-12'>
                <div className='widget widget-menu style-3 '>
                  ...
                  <ul className='box-menu'>
                    <li>
                      <a href='properties-list.html'>Property For Sale</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href='https://themesflat.co/html/dreamhomehtml/portfolio.html'>
                        FAQ
                      </a>
                    </li>
                    <li>
              ...
              <div className='col-lg-3 col-md-6 col-12'>
                <div className='widget widget-menu widget-form'>
                  ...
                  <form
                    ...
                    acceptCharset='utf-8'
                  >
                    <p className='font-2 text-color-8'>
                    ...
                    <label className='flex'>
                      ...
                      <span className='fs-12 text-color-8 lh-18'>
        ...
        {/* /#footer */}
        <div className='widget-logo-footer'>
          <div className='container'>
            <div className='row'>
              <div className='col-lg-12'>
                <div className='wrap-logo flex align-center justify-space'>
                  <div className='logo-footer style box-1' id='logo-footer'>
                    <a href='index.html'>
                      <img
                  ...
                  <div className='box-menu box-2'>
                    <ul className='menu-bottom flex align-center fs-16 fw-6'>
                      <li>
                        <a href='index.html'>Home</a>{' '}
                      </li>
                      <li>
                        <a href='properties-grid.html'>Property</a>{' '}
                      </li>
                      <li>
