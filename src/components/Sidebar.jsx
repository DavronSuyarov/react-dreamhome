...
const Sidebar = () => {
  ...
  return (
    <>
      <div onClick={() => setToggle(!toggle)} className='btn2 header-item '>
        ...
        <div id='sidebar-menu'>
          ...
          <div className='logo-box d-flex'>
            <div className='logo'>
              <a href='index.html'>
                <img
                  src='assets/images/logo/logo3@2x.png'
                  alt=''
                  width={197}
                  height={48}
                  className='img-logo'
                />
                <img
                  src='assets/images/logo/toggle-logo@2x.png'
                  alt=''
                  width={46}
                  height={48}
          ...
          <ul className='downmenu list-unstyled' id='side-menu'>
            {pages.map((item, index) => (
              <li>
                <Link to={item.path} key={index} className='tf-effect'>
                  {item.icon}
            ...
            <li>
              <a href='dashboard.html' className='tf-effect'>
                <span className='icon-dash dash-icon'>
                  <svg
                    width={22}
                    height={22}
            ...
            <li>
              <a href='dashboard-profile.html' className='has-arrow tf-effect'>
                <span className='icon-dash dash-icon'>
                  <svg
                    width={22}
                    height={22}
            ...
            <li>
              <a href='dashboard-review.html' className='tf-effect'>
            ...
            <li>
              <a href='dashboard-properties.html' className='tf-effect'>
                <span className='icon-applicant dash-icon'>
                  ...
                  >
                    ...
                    />
                    <path
                      d='M13.8984 4.21893L18.0839 8.40443'
                      stroke='#F1FAEE'
                      strokeWidth='1.5'
                      strokeLinecap='round'
                      strokeLinejoin='round'
                ...
                <span className='icon-submit dash-icon'>
                  ...
                  >
                    <path
                      fillRule='evenodd'
                      clipRule='evenodd'
                      d='M17.4808 17.4807C14.6793 20.2825 10.531 20.8878 7.13625 19.3178C6.6351 19.1161 6.22423 18.953 5.83362 18.953C4.74565 18.9594 3.39143 20.0144 2.68761 19.3114C1.98379 18.6075 3.03952 17.2522 3.03952 16.1577C3.03952 15.767 2.88291 15.3635 2.68116 14.8613C1.11046 11.4671 1.71663 7.31744 4.5181 4.51659C8.09433 0.939042 13.9045 0.939042 17.4808 4.51566C21.0635 8.09874 21.057 13.9041 17.4808 17.4807Z'
                      stroke='#F1FAEE'
                      strokeWidth='1.5'
                      strokeLinecap='round'
                      strokeLinejoin='round'
              ...
              <a href='#' className='tf-effect'>
                <span className='icon-bell1 dash-icon'>
                  ...
                  >
                    ...
                    />
                    <path
                      d='M16.5156 16.9447L19.746 20.1667'
                      stroke='#F1FAEE'
                      strokeWidth='1.5'
                      strokeLinecap='round'
                      strokeLinejoin='round'
            ...
            <li>
              <a href='index.html' className='tf-effect'>
